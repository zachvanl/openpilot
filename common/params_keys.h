...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"LongitudinalTFollowAggressive", {PERSISTENT | BACKUP, FLOAT, "1.25"}},
    {"LongitudinalTFollowStandard", {PERSISTENT | BACKUP, FLOAT, "1.45"}},
    {"LongitudinalTFollowRelaxed", {PERSISTENT | BACKUP, FLOAT, "1.75"}},
    ...
    {"CityCruiseAssist", {PERSISTENT | BACKUP, BOOL, "1"}},
    {"CityApproachEarlySlow", {PERSISTENT | BACKUP, BOOL, "1"}},
    {"CityApproachMinDistFt", {PERSISTENT | BACKUP, FLOAT, "100"}},
    {"CityApproachMaxDistFt", {PERSISTENT | BACKUP, FLOAT, "150"}},
    {"CityApproachMinClosingMph", {PERSISTENT | BACKUP, FLOAT, "7"}},
    {"CityApproachFarBufferMph", {PERSISTENT | BACKUP, FLOAT, "20"}},
    {"CityEstablishedFollowCoast", {PERSISTENT | BACKUP, BOOL, "1"}},
    {"CityEstablishedFollowTimeS", {PERSISTENT | BACKUP, FLOAT, "6"}},
    {"CityLateBrakeAssist", {PERSISTENT | BACKUP, BOOL, "1"}},
    {"CityCoastMaxLeadAccel", {PERSISTENT | BACKUP, FLOAT, "-0.9"}},
    {"CityHardBrakeLeadAccel", {PERSISTENT | BACKUP, FLOAT, "-2.0"}},
    ...
    {"LeadHysteresis", {PERSISTENT | BACKUP, BOOL, "0"}},
    ...
    {"CruiseSetUseSpeedLimit", {PERSISTENT | BACKUP, BOOL, "0"}},
